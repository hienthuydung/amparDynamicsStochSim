...
# This program was used to create Fig. 4.1 and 4.3 of the manuscript.
...
plt.xscale('log')
plt.yscale('log')
colors = ['green','cyan','darkviolet'] # set the colors
labels = [r'$\phi=1.0$', r'$\phi=2.67$',r'$\phi=5.0$'] # set the labels of CV
